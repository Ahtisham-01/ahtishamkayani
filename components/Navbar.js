                ...
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
                    ...
                    <div id="mega-menu-full" className="items-center justify-between font-medium hidden w-full md:flex md:w-auto md:order-1">
                        <ul className="flex flex-col  mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0  ">
                            <li>
                                <a href="#overview" className="block py-2 pl-3 pr-4  text-gray-100 rounded hover:bg-[#A020F0]   p-2 dark:text-white" >Overview</a>
                            </li>
                            <li>
                                <a href="#experience" className="block py-2 pl-3 pr-4 text-gray-100 rounded hover:bg-[#A020F0]    p-2 dark:text-white " >Experience</a>
                            </li>
                            <li>
                                <a href="#project" className="block py-2 pl-3 pr-4 text-gray-100 rounded hover:bg-[#A020F0]   p-2 dark:text-white " >Projects</a>
                            </li>
                            <li>
                                <a href="#contact" className="block py-2 pl-3 pr-4 text-gray-100 rounded hover:bg-[#A020F0]   p-2 dark:text-white " >Contact</a>
                            </li>
